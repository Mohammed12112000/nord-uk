(function ($) {
	...
	/*---------------------------------
        Desktop Menu Active Sync
    -----------------------------------*/
	function syncDesktopMenuActiveTab() {
		var path = window.location.pathname.split('/').pop() || 'index.html';
		var activeHref = 'index.html';

		if (path === 'about.html' || path === 'blog.html') {
			activeHref = 'about.html';
		} else if (path === 'contact.html') {
			activeHref = 'contact.html';
		} else if (path === 'blog-details.html' || path.indexOf('project') === 0 || path === 'miscellaneous-works.html') {
			activeHref = 'blog-details.html';
		}

		var $desktopLinks = $('.main-menu.main-menu-white > ul > li > a');
